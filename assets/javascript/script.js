$(document).ready(function() {
    ...
    function currentTrendingAlbums() {
        const queryURL = `https://theaudiodb.com/api/v1/json/API_KEY/trending.php?country=us&type=itunes&format=albums`
        $.ajax({
            url: queryURL,
            method: "GET"
    ...
    function currentTrendingSongs() {
        const queryURL = `https://theaudiodb.com/api/v1/json/API_KEY/trending.php?country=us&type=itunes&format=singles`
        $.ajax({
            url: queryURL,
            method: "GET"
        }).then (function(response){
    ...
    $("#submit-button").on("click", function(event) {
        ...
        function displayArtist() {
            ...
            const queryURL = `https://www.theaudiodb.com/api/v1/json/API_KEY/search.php?s=${artistName}`;
            ...
            $.ajax({
                ...
                function discography() {
                    const queryURL = `https://www.theaudiodb.com/api/v1/json/API_KEY/discography.php?s=${artistName}`;
                ...
                function mostLovedTracks() {
                    const queryURL = `https://www.theaudiodb.com/api/v1/json/API_KEY/track-top10.php?s=${artistName}`
                ...
                function musicVideos() {
                    const queryURL = `https://www.theaudiodb.com/api/v1/json/API_KEY/mvid.php?i=${response.artists[0].idArtist}`
        ...
        function displayAlbum() {
            ...
            const queryURL = `https://www.theaudiodb.com/api/v1/json/API_KEY/searchalbum.php?s=${albumNameFromArtist}&a=${albumName}`;
        ...
        function displayTrack() {
            ...
            const queryURL = `https://www.theaudiodb.com/api/v1/json/API_KEY/searchtrack.php?s=${trackNameFromArtist}&t=${trackName}`;
